...
TEST_CSV = BASE_DIR / "deep_learning/datasets/arabic_context_to_idiom/test.csv"
BANK_CSV = BASE_DIR / "deep_learning/datasets/idiom_bank/idiom_bank.csv"
OUTPUT_DIR = BASE_DIR / "deep_learning/models/xlmr_arabic_context_to_idiom_retrieval"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

print("Loading test split and idiom bank...")

test_df = pd.read_csv(TEST_CSV, low_memory=False)
bank_df = pd.read_csv(BANK_CSV, low_memory=False)

# Keep only idioms that belong to the bank
...
# Build bank representations
bank_texts = bank_df["retrieval_text_multilingual"].astype(str).tolist()
...
print("Encoding Arabic test contexts...")
